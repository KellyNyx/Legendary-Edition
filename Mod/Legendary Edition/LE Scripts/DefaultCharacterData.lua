...
-- CurrentWeaponInSlot = GetEquippedWeapon()
-- CurrentCharacterTrait = EPCGetWeaponUpgradeTrait(CurrentWeaponInSlot, GameState.LastWeaponUpgradeData[CurrentWeaponInSlot].Index)
-- CurrentCharacterVoiceLines = TraitData[CurrentCharacterTrait].CharacterVoiceLines or DefaultCharacterData.DefaultCharacterVoiceLines

--HeroVoiceLines = CurrentCharacterVoiceLines